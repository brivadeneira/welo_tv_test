...
class TestJustifyText(unittest.TestCase):
    def test_justify(self):
        text = "La historia de la ópera tiene una duración relativamente " \
               "corta dentro del contexto de la historia de la música " \
               "en general: apareció en 1597, fecha en que se creó " \
               "la primera ópera."
        line_width = 30
